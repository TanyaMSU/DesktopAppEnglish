...
{
    public partial class ReportedPractice : Form
    {
        string pathToFile;
        ...
        public ReportedPractice()
        {
            InitializeComponent();

            infoFromFile = new QuestionsAnswers();
            pathToFile = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "ReportedSpeech.txt");
            ...
            label_question.Text = "Change the direct speech into reported speech.\nWrite 'that' where possible.\nExample: I said that I loved you.";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            switch (button_check.Text)
            {
                ...
                case "Check it!":
                    ...
                    {
                        string pathToImage = @"C:\Userp\123123.png";
